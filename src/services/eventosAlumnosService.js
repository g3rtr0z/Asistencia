...
export const getAlumnosEjemploPorEvento = (eventoId) => {
  ...
  const eventosPorNombre = {
    'Seminario de Informática 2025': [
      { nombres: 'Juan', apellidos: 'Pérez', rut: '12345678-9', carrera: 'Informática', institucion: 'Santo Tomás', asiento: 'A1', grupo: '1' },
      { nombres: 'María', apellidos: 'González', rut: '23456789-0', carrera: 'Informática', institucion: 'Santo Tomás', asiento: 'A2', grupo: '1' },
      { nombres: 'Carlos', apellidos: 'Rodríguez', rut: '34567890-1', carrera: 'Informática', institucion: 'Santo Tomás', asiento: 'A3', grupo: '2' },
      { nombres: 'Ana', apellidos: 'López', rut: '45678901-2', carrera: 'Informática', institucion: 'Santo Tomás', asiento: 'A4', grupo: '2' },
      { nombres: 'Luis', apellidos: 'Martínez', rut: '56789012-3', carrera: 'Informática', institucion: 'Santo Tomás', asiento: 'A5', grupo: '3' },
    ],
    'Conferencia de Ingeniería': [
      { nombres: 'Pedro', apellidos: 'García', rut: '67890123-4', carrera: 'Ingeniería', institucion: 'Santo Tomás', asiento: 'B1', grupo: '1' },
      { nombres: 'Carmen', apellidos: 'Fernández', rut: '78901234-5', carrera: 'Ingeniería', institucion: 'Santo Tomás', asiento: 'B2', grupo: '1' },
      { nombres: 'Roberto', apellidos: 'Sánchez', rut: '89012345-6', carrera: 'Ingeniería', institucion: 'Santo Tomás', asiento: 'B3', grupo: '2' },
    ],
    'Workshop de Administración': [
      { nombres: 'Isabel', apellidos: 'Torres', rut: '90123456-7', carrera: 'Administración', institucion: 'Santo Tomás', asiento: 'C1', grupo: '1' },
      { nombres: 'Miguel', apellidos: 'Ruiz', rut: '01234567-8', carrera: 'Administración', institucion: 'Santo Tomás', asiento: 'C2', grupo: '1' },
      { nombres: 'Elena', apellidos: 'Jiménez', rut: '12345678-9', carrera: 'Administración', institucion: 'Santo Tomás', asiento: 'C3', grupo: '2' },
      { nombres: 'Francisco', apellidos: 'Moreno', rut: '23456789-0', carrera: 'Administración', institucion: 'Santo Tomás', asiento: 'C4', grupo: '2' },
    ]
  };

  // Buscar el evento por ID y obtener su nombre
