...
function AdminLogin({ onAuth, onSalir }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white p-4">
      ...
      >
        {/* Header */}
        <div className="bg-white border border-slate-200 rounded-lg p-10 mb-10 shadow-sm">
                      <div className="flex items-center gap-3 mb-4">
              <div className="w-3 h-3 bg-green-700 rounded-full"></div>
              <h1 className="text-lg font-semibold text-slate-800">Acceso Administrador</h1>
            </div>

          <p className="text-sm text-slate-600 mb-6">Ingresa tus credenciales institucionales</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all duration-200 text-sm"
            ...
            <div className="flex gap-3 pt-2">
              ...
              <motion.button
                type="button"
                className="px-6 py-3 text-slate-600 text-sm hover:text-slate-800 transition-colors"
                onClick={onSalir}
