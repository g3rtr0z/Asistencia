...
function EventoActivoInfo({ eventoActivo }) {
  ...
  return (
    ...
    >
      ...
      <div className="ml-6">
        <h4 className="text-xl font-bold text-gray-800 mb-3 leading-tight">{eventoActivo.nombre}</h4>
        <p className="text-gray-600 mb-4 leading-relaxed">{eventoActivo.descripcion}</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-500">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600">{formatDate(eventoActivo.fechaInicio)}</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="font-medium text-green-700">Fin:</span>
            <span className="text-gray-600">{formatDate(eventoActivo.fechaFin)}</span>
          </div>
        </div>
      </div>
    </motion.div>
