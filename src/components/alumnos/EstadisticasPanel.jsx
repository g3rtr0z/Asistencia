...
function EstadisticasPanel({ alumnos, soloPresentes, setSoloPresentes, alumnosCompletos, eventoActivo }) {
  ...
  const handleExportarFiltrado = (filtro) => {
    if (eventoActivo && alumnosCompletos) {
      exportarAExcel(alumnosCompletos, eventoActivo.nombre, eventoActivo.tipo, filtro);
    }
  };
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-4">
        ...
        <div className="relative">
          <motion.button
            ...
            className={`p-3 rounded-lg border transition-all duration-200 w-full ${soloPresentes === "presentes"
        ...
        <div className="relative">
          <motion.button
            ...
            className={`p-3 rounded-lg border transition-all duration-200 w-full ${soloPresentes === "ausentes"
